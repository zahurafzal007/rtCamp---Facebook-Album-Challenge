...
require_once 'Facebook/FacebookRequest.php';
  ...
  if(!isset($_COOKIE['credentials']) && isset($_GET['code'])){
    ...
    header('Location: https://fbrtcamp.herokuapp.com/userhome.php?code='.$_GET['code']);
  }

    use Facebook\FacebookRequest;
    //session_start();
    $fb = new Facebook\Facebook([
  'app_id' => '1963413130541591',
...
if(isset($_SESSION['fb_access_token'])){
    ...
    $appId = '963413130541591'; 
    $appSecret = 'd5c0c1ce4c42c3476fb038f66a88e7ef';
    ...
    <body id="top" data-spy="scroll" data-target="#materialize-menu" data-offset="148">
                ...
                <div class="container">
                    <div id="materialize-menu" class="menuzord">
                        ...
                        <a href="#top" class="logo-brand page-scroll"  data-section="#top">
                            ...
                            <h2 style="color:white;" class="text-extrabold text-uppercase"><i class="fa fa-picture-o"></i>&nbsp;Photo Phactory</h2>
                        </a>
                        <!--logo end-->
        ...
        <section id="about" class="section-padding">
          <div class="container">
                ...
                <div class="text-center mb-80 wow fadeInUp animated" style="visibility: visible; animation-name: fadeInUp;">
                    <center><h1 class="text-uppercase mb-30 wow fadeInLeft animated" style="visibility: visible; animation-name: fadeInLeft;">Photo Phactory</h1></center>
                    ...
                    <p class="card-title activator wow fadeInRight animated" style="font-size:1.5em;visibility: visible; animation-name: fadeInRight;">
                      Welcome to <a>Photo Phactory</a>. Here you can View and Manage your Facebook Albums by <a>downloading <i class="fa fa-download"></i></a> them to your PC or by <a>uploading <i class="fa fa-cloud-upload"></i></a> them to your Google Drive(Login Required).
                    </p>
                </div>
            </div>
        </section>
        ...
        <footer class="footer footer-two">
            ...
            <div class="secondary-footer brand-bg darken-2">
                <div class="container text-center">
                    <span class="copy-text">Copyright &copy; 2017-18 <a>Photo Phactory</a> &nbsp;  | &nbsp;  All Rights Reserved &nbsp;  | &nbsp;  Designed By <a>Zahurafzal Mirza</a></span>
                </div><!-- /.container -->
        ...
        <div id="preloader">
          <div class="preloader-position"> 
            <h2 class="text-extrabold text-uppercase" style="font-size: 3em;color: #03a9f4;"><i class="fa fa-picture-o"></i>&nbsp;Photo Phactory</h2>
